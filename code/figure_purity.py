"""
Script used to plot Fig.7 of [arXiv:2012.01459]
"""
...
for ii in range(len(filenames)):
    ...
    print(f"M={m}, average purity = ",np.average(purity))

    #axs[3].scatter(t,purity, marker='.', color= tuple(nice_blue))
    axs[ii].scatter(t,purity, marker='.', color= tuple(nice_blue))
    ...
    axs[ii].plot(t, 1/2+ans[0][0]*np.exp(-ans[0][1]*t),'--',color= tuple(0.7*nice_blue))
